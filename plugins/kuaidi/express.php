...
{
$express_info = '<span style="font-size:18px;">很抱歉，暂时无法查询此订单信息！请尝试跳转到网页查询</span><a href='."http://www.kuaidi100.com/chaxun?com={$postcom}&nu={$express_no}".'><span style="color:red;">点击跳转</span></a>';//liu 改
}
