    ...
    if ($GLOBALS['db']->query($sql, 'SILENT')) {
        ...
        if($parent_id){
            ...
            foreach ($region_list1 as $key => $row) {
                ...
                $sql = "INSERT INTO " . $ecs->table('region_warehouse') . " (regionId, parent_id, region_name, region_type) " .
                        "VALUES ('" . $row['region_id'] . "', '$rw_id1', '" . $row['region_name'] . "', '$rl_region_type1')";
                ...
                foreach ($region_list2 as $k => $r) {
                    ...
                    $sql = "INSERT INTO " . $ecs->table('region_warehouse') . " (regionId, parent_id, region_name, region_type) " .
                            "VALUES ('" . $r['region_id'] . "', '$rw_id2', '" . $r['region_name'] . "', '$rl_region_type2')";
                    $GLOBALS['db']->query($sql);
                    ...
                    foreach ($street_list as $sk => $sr) {
                        ...
                        $sql = "INSERT INTO " . $ecs->table('region_warehouse') . " (regionId, parent_id, region_name, region_type) " .
                                "VALUES ('" . $sr['region_id'] . "', '$rw_id3', '" . $sr['region_name'] . "', '$rl_region_type3')";
                        $GLOBALS['db']->query($sql);
                    }
                }
            }
