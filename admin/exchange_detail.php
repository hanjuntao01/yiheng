...
function get_seller_goods_exchange($user_id = 0) {
    ...
    $sql = "SELECT g.goods_id, g.goods_name, g.goods_thumb, g.give_integral, g.rank_integral, model_price, is_promote, promote_price, shop_price, model_price FROM " . 
            $GLOBALS['ecs']->table('goods') . " AS g WHERE g.user_id = '$user_id'";
