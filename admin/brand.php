...
elseif ($_REQUEST['act'] == 'edit')
{
	...
	$brand['index_img'] = empty($brand['index_img']) ? '' : "../" . DATA_DIR . '/indeximg/'.$brand['index_img']; //品牌专区大图 by wu
	$brand['brand_bg'] = empty($brand['brand_bg']) ? '' : "../" . DATA_DIR . '/brandbg/'.$brand['brand_bg']; //品牌背景图图 
