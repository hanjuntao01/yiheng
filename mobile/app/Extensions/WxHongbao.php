...
class WxHongbao
{
    ...
    */
    ...
    public function curl_post_ssl($url, $vars, $second = 30, $aHeader = array())
    {
        ...
        // 上传证书到服务器
        curl_setopt($ch, CURLOPT_SSLCERT, ROOT_PATH . 'storage/app/certs/wxpay/apiclient_cert.pem');
        curl_setopt($ch, CURLOPT_SSLKEY, ROOT_PATH . 'storage/app/certs//wxpay/apiclient_key.pem');
        curl_setopt($ch, CURLOPT_CAINFO, ROOT_PATH . 'storage/app/certs//wxpay/rootca.pem');
