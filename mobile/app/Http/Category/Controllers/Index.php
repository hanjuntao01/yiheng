...
class Index extends Frontend
{
    ...
    public function actionProducts()
    {
        ...
        $description = !empty($this->keyword) ? $cat_goods['goods_name'] : $cat_info['cat_desc']; // 分类描述
        $share_data = array(
            'title' => $page_title,
            'desc' => $description,
            'link' => '',
    ...
    public function actionSearch()
    {
        ...
        $keywords = input('keyword', '', 'addslashes');
        // 店铺搜索
        if ($type_select == 1) {
    ...
    private function init_params()
    {
        ...
        //关键词查询
        $keyword = I('request.keyword', '', 'addslashes');
        ...
        $sql = "SELECT b.brand_id, b.brand_name, b.brand_logo, COUNT(*) AS goods_num " . $brand_select .
            ...
            " WHERE $this->children OR " . 'gc.cat_id ' . db_create_in(array_unique(array_merge(array($this->cat_id), array_keys(cat_list($this->cat_id, 0))))) . " AND b.is_show = 1 " .
