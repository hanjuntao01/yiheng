...
use App\Http\Admin\Controllers\EditorSeller;
use App\Libraries\Image;

class ApiSeller extends EditorSeller
{
        ...
        if (IS_POST) {
            ...
            switch ($type) {
                case "new":
                    ...
                    break;
                case "best":
                    $where .= ($user_id > 0) ? " AND  g.store_best = '1' " : " AND  g.is_best = '1' ";
                    break;
                case "hot":
    ...
    */
    ...
    /**
     * 创建商家相册
     * post: /index.php?m=console&c=apiseller&a=MakeGallery
     * param: $ru_id  商家ID
     * return:
     */
    ...
    /*
     *商品列表
     * post: /index.php?m=console&c=apiseller&a=goodslist
     */
