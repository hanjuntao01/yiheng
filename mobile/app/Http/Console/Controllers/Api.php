...
use App\Http\Admin\Controllers\Editor;
use App\Libraries\Image;

class Api extends Editor
{
    ...
    public function actionProduct()
    {
        if (IS_POST) {
            ...
            $sql = 'SELECT g.goods_id, g.user_id, g.goods_name, g.goods_number, ' . $shop_price . ' g.goods_name_style, g.comments_number,g.sales_volume,g.market_price, g.is_new, g.is_best, g.is_hot, ' .
                ...
                "WHERE $where ORDER BY g.sort_order ASC , g.goods_id DESC $wherenum";
            ...
            $sql = 'SELECT g.goods_id ' .
                ...
                'LEFT JOIN ' . $GLOBALS['ecs']->table('member_price') . ' AS mp ' .
                "ON mp.goods_id = g.goods_id AND mp.user_rank = '$_SESSION[user_rank]' " .
                "WHERE $where ORDER BY g.sort_order ASC , g.goods_id DESC ";
    ...
    public function actionUrl()
    {
        if (IS_POST) {
            ...
            if ($type == 'function') {
                ...
                $url = array('0' => $category, '1' => $cart, '2' => $user, '3' => $store, '4' => $brand, '5' => $community);
                ...
                $url = array('0' => $groupbuy, '1' => $exchange, '2' => $crowd_funding, '3' => $topic, '4' => $activity, '5' => $auction, '6' => $seckill, '7' => $team);
                ...
                foreach ($url as $key => $value) {
                    $url[$key] = array(
                        ...
                        'url' => url('topic/index/detail', array('topic_id' => $value['topic_id']))
                    );
                }
    ...
    */
    ...
    /*
     *商品列表
     * post: /index.php?m=console&c=api&a=goodslist
     */
