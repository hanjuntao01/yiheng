...
{
    $sql = "SELECT g.goods_id,g.cat_id, ga.act_ensure,g.goods_desc as goods_desc_old,  g.goods_sn, g.is_real, g.goods_name, g.extension_code, g.market_price, g.shop_price AS org_price, product_id, " .
            "g.goods_img, g.user_id," .
