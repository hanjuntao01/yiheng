...
elseif($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit'){
    ...
    if($_REQUEST['act'] == 'insert'){
        ...
        $time = gmtime();
        $sql = "INSERT INTO".$ecs->table("offline_store")."(`stores_name`,`country`,`province`,`city`,"
                . "`district`,`stores_address`,`stores_tel`,`stores_opening_hours`,`stores_traffic_line`,`stores_img`,`is_confirm`,`ru_id`,`add_time`)"
                . " VALUES ('$stores_name','$country','$province','$city','$district','$stores_address'"
                . ",'$stores_tel','$stores_opening_hours','$stores_traffic_line','$file_url','$is_confirm','".$adminru['ru_id']."','$time')";
        ...
        $sql = "UPDATE".$ecs->table('offline_store')." SET stores_name='$stores_name',country='$country'"
                ...
                . "stores_opening_hours='$stores_opening_hours',stores_traffic_line='$stores_traffic_line',stores_img='$file_url',is_confirm='$is_confirm' WHERE id = '$id'";
        if($db->query($sql) == true){
