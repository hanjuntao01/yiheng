...
function order_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT ifnull(bai.is_stages,0) is_stages, o.order_id, o.main_order_id, o.order_sn, o.add_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid, o.is_delete," .
                ...
                "o.shipping_time, o.auto_delivery_time, o.pay_status, o.consignee, o.address, o.email, o.tel, o.mobile, o.extension_code AS o_extension_code, " .
                "o.extension_id, o.user_id, o.referer, o.froms, o.chargeoff_status, " .
