...
define('MOBILE_WECHAT',             ROOT_PATH . 'mobile/app/Http/Wechat'); //微商城目录
define('MOBILE_DRP',                ROOT_PATH . 'mobile/app/Http/Drp'); //微分销目录
define('MOBILE_TEAM',               ROOT_PATH . 'mobile/app/Http/Team'); //拼团目录
